#ifndef _CPP_LOSS_MULTICLASS_LOG_DEFINES_AGE_DEFINES_H_
#define _CPP_LOSS_MULTICLASS_LOG_DEFINES_AGE_DEFINES_H_
...
// https://github.com/GilLevi/AgeGenderDeepLearning/blob/master/age_net_definitions/deploy.prototxt
...
template <typename SUBNET>
using fc8 = add_layer<fc_<8, FC_HAS_BIAS>, SUBNET>;
using age_train_type = loss_multiclass_log<fc8<
							               dropout<
							               relu<fc7<dropout<
							               relu<fc6<pool5<
